...
// ── Reactive locale (bridges lingua's subscribe()/locale into a ripple signal via
// `fromSubscribable` — the same structural adapter pattern used by board-store.ts's activeRoute
// and realtime.ts's presenceSignal) ────────────────────────────────────────────────────────
