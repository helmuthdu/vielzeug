 ...
 * copied just this `demos/kanban` folder) — callers fall back to the real npm dependencies.
 *
 * @param demoRoot absolute path to this demo's own directory (`demos/kanban`)
