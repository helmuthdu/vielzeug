...
const destinationTemplates: Destination[] = [
  {
    ...
    feature: {
      ...
      image: assetUrl('images/tokyo.webp'),
      imageAlt: 'Tokyo skyline glowing in the morning light',
    },
  ...
  },
  {
    ...
    feature: {
      ...
      image: assetUrl('images/kyoto.webp'),
      imageAlt: 'Golden Pavilion reflected in its garden pond',
    },
    id: 'kyoto',
    image: assetUrl('images/kyoto.webp'),
    name: 'Kyoto',
  ...
  },
  {
    ...
    feature: {
      ...
      image: assetUrl('images/osaka.webp'),
      imageAlt: 'Osaka Castle framed by its surrounding gardens',
    },
    id: 'osaka',
    image: assetUrl('images/osaka.webp'),
    name: 'Osaka',
  ...
  },
  {
    ...
    feature: {
      ...
      image: assetUrl('images/hakone.webp'),
      imageAlt: 'Mount Fuji beyond the Hakone mountains',
    },
    id: 'hakone',
    image: assetUrl('images/hakone.webp'),
    name: 'Hakone',
  ...
  },
  {
    ...
    feature: {
      ...
      image: assetUrl('images/hokkaido.webp'),
      imageAlt: 'Lavender fields across the Hokkaido countryside',
    },
    id: 'hokkaido',
    image: assetUrl('images/hokkaido.webp'),
    name: 'Hokkaido',
...
const hotelTemplates: Hotel[] = [
  {
    ...
    destinationId: 'tokyo',
    gallery: [
      { alt: 'Tokyo skyline near the hotel', src: assetUrl('images/tokyo.webp') },
      { alt: 'Japanese-style guest room', src: assetUrl('images/room.webp') },
      { alt: 'Traditional Japanese breakfast', src: assetUrl('images/breakfast.webp') },
    ],
    id: 'tokyo-house',
  ...
  },
  {
    ...
    destinationId: 'tokyo',
    gallery: [
      { alt: 'Azabudai and central Tokyo', src: assetUrl('images/tokyo.webp') },
      { alt: 'Tatami guest room', src: assetUrl('images/room.webp') },
      { alt: 'Japanese breakfast service', src: assetUrl('images/breakfast.webp') },
    ],
    id: 'azabu-ryokan',
  ...
  },
  {
    ...
    destinationId: 'tokyo',
    gallery: [
      { alt: 'Tokyo skyline seen from Ginza', src: assetUrl('images/tokyo.webp') },
      { alt: 'Contemporary Japanese guest room', src: assetUrl('images/room.webp') },
      { alt: 'Breakfast prepared for hotel guests', src: assetUrl('images/breakfast.webp') },
    ],
    id: 'ginza-edition',
  ...
  },
  {
    ...
    destinationId: 'kyoto',
    gallery: [
      { alt: 'Golden Pavilion and its Kyoto garden', src: assetUrl('images/kyoto.webp') },
      { alt: 'Japanese-style garden room', src: assetUrl('images/room.webp') },
      { alt: 'Traditional Kyoto breakfast', src: assetUrl('images/breakfast.webp') },
    ],
    id: 'kyoto-garden',
  ...
  },
  {
    ...
    destinationId: 'osaka',
    gallery: [
      { alt: 'Osaka Castle and the city gardens', src: assetUrl('images/osaka.webp') },
      { alt: 'Modern Japanese guest room', src: assetUrl('images/room.webp') },
      { alt: 'Japanese breakfast selection', src: assetUrl('images/breakfast.webp') },
    ],
    id: 'naniwa-stay',
