...
// `@vielzeug/refine/tokens.css`) — this extensionless subpath needs its own declaration
// for the side-effect import in main.ts. Mirrors demos/crm/src/vite-env.d.ts.
