---
title: Worker — Web Workers made type-safe
...
<PackageBadges package="worker" />

<img src="/logo-worker.svg" alt="Worker logo" width="156" class="logo-highlight"/>
...
**Related:** [Toolkit](/toolkit/) · [Ripple](/ripple/) · [Relay](/relay/)
...
| ----------------- | -------------------------------------------- | ------- | ---------- |
| Bundle size       | <PackageInfo package="worker" type="size" /> | ~2 kB   | ~10 kB     |
| Worker pools      | ✅                                           | ❌      | ✅         |
