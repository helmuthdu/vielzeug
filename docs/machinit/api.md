---
title: Machinit - API Reference
description: Complete type and function documentation for Machinit.
---
...
State and context are reactive signals from `@vielzeug/stateit`. Use `effect()` to subscribe to changes.
