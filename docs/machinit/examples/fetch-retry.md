---
title: 'Machinit Examples — Fetch with Retry'
description: 'Data fetching with automatic retry logic using @vielzeug/machinit.'
---
...
- [Fetchit documentation](/fetchit/) — HTTP client with built-in caching and mutations
