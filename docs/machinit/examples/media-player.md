---
title: 'Machinit Examples — Media Player'
description: 'Playback control with async loading states using @vielzeug/machinit.'
---
...
- [Craftit documentation](/craftit/) — Binding player state to UI reactively
