---
title: 'Machinit Examples — Shopping Cart Checkout'
description: 'E-commerce checkout flow with persistence using @vielzeug/machinit.'
---
...
- [Deposit documentation](/deposit/) — IndexedDB + LocalStorage API for persistence
- [Form with Validation](./form-validation.md) — Multi-step flows with validation
- [Fetchit documentation](/fetchit/) — POST requests during confirming state
