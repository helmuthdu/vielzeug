...
| `get-component` | Tool | `tagName` | JSON Buildit component declaration |
...
```json
[
  { "name": "@vielzeug/validit", "slug": "validit", "matchedIn": "metadata" },
  { "name": "@vielzeug/formit", "slug": "formit", "matchedIn": "docs", "matchedPage": "usage" }
]
```
...
Returns Buildit component tags from bundled component metadata.

**Input:** none

**Error cases:** missing bundled Buildit component metadata returns `isError: true`.

---

### `get-component`

Returns one full Buildit component declaration by `tagName`.
