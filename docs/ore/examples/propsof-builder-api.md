...
You need to define typed component props with sensible defaults, attribute reflection, and custom parsing. Ore provides both convenience helpers and a raw escape hatch.
