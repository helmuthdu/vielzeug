...
exports:
  [s, Schema, WrapperSchema, PipeSchema, ValidationError, ErrorCode, errorsAt, fail, fromDescriptor, descriptorToJsonSchema, configure, currentLocale, registerLocale, useLocale, reset]
---
