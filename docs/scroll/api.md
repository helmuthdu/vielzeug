...
| Import                  | Purpose                |
| ----------------------- | ---------------------- |
| `@vielzeug/scroll`   | Main exports and types |
...
```ts
export { createVirtualizer } from '@vielzeug/scroll';
export type {
  Overscan,
...
export { createDomVirtualList } from '@vielzeug/scroll/dom';
export type {
  DomVirtualListController,
  DomVirtualListOptions,
  DomVirtualListRenderArgs,
} from '@vielzeug/scroll/dom';
```
