---
title: 'Block Examples — Settings Panel with Switches'
...
Implement settings panel with switches in a production-friendly way with `@vielzeug/block` while keeping setup and cleanup explicit.

## Runnable Example

The snippet below is copy-paste runnable in a TypeScript project with `@vielzeug/block` installed.
