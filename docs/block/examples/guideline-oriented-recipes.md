---
title: 'Block Examples — Guideline-Oriented Recipes'
...
Implement guideline-oriented recipes in a production-friendly way with `@vielzeug/block` while keeping setup and cleanup explicit.
