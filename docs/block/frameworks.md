---
title: Block — Framework Integration
description: Using Block web components with React, Vue 3, Svelte, and Angular.
---
...
Block is built on native Web Components standards and works in every framework that can render HTML. The components behave like regular HTML elements: set attributes, listen to events, use slots for content projection.
