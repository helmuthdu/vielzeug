---
title: 'Deposit Examples — Lazy Iteration'
description: 'Stream large IndexedDB tables record-by-record with iterate() in @vielzeug/deposit.'
---
...
- Calling `db.iterate(table)` after `db.dispose()` throws `DepositDisposedError` synchronously on the first `next()` call.

### Related

- [Querying](./querying.md)
- [TTL and Pruning](./ttl.md)
- [API Reference — IndexedDbAdapter](/deposit/api.md#indexeddbadapter)
- [IndexedDB](/deposit/usage.md#lazy-iteration-indexeddb)
