---
title: 'Deposit Examples — TTL and Pruning'
description: 'Write records with expiry and prune expired records in @vielzeug/deposit.'
---
...
```ts
import { createMemory, scheduleExpiredPrune, table, ttl } from '@vielzeug/deposit';
...
- [Usage Guide — Use TTL](/deposit/usage.md#use-ttl)
- [API Reference — `scheduleExpiredPrune`](/deposit/api.md#scheduleexpiredprune)
