...
description: 'Wildcard action example for @vielzeug/permit.'
---
...
permit.can({ id: 'u1', roles: ['admin'] }, 'posts', 'delete'); // true
permit.can({ id: 'u1', roles: ['admin'] }, 'posts', 'archive'); // true — any string action matches
