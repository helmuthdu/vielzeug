...
description: 'Bound guard in UI layer example for @vielzeug/permit.'
---
...
Call `forUser()` once when the user context is established. It returns a `BoundPermit` that snapshots the principal and binds all decision methods to it.
