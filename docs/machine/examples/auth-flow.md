---
title: 'Machine Examples — Auth Flow with Guards'
description: Auth flow with guards example for @vielzeug/machine.
---
...
- [API Reference — `GuardFn`](/machine/api#guardfnctx-ev)
