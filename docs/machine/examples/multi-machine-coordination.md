...
description: Use Relay to coordinate multiple independent Machine state machines.
---
...
Use Relay as a message bus to decouple machines. Each machine publishes events about state changes, and other machines subscribe and react accordingly. This creates a pub/sub pattern where machines are independent but coordinated.

```ts
import { defineMachine, interpret, assign } from '@vielzeug/machine';
import { createEventBus } from '@vielzeug/relay';
...
- [Relay](../relay/) - Typed event bus and pub/sub
