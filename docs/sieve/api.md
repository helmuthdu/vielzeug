---
title: Sieve — API Reference
description: Complete reference for sieve exports, v factories, schema methods, specialized schemas, messages, types, and errors.
---
...
| Import                | Purpose                |
| --------------------- | ---------------------- |
| `@vielzeug/sieve`   | Main exports and types |
...
`@vielzeug/sieve` exports `v` as the canonical schema factory namespace.
...
Sieve exposes low-level schema metadata for advanced tooling:
