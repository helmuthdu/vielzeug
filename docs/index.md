...
features:
  ...
  - title: '@vielzeug/clockwork'
    details: "<img src='/logo-clockwork.svg' class='logo-highlight-smaller' alt='Clockwork Logo' width='72'/>Typed finite state machines with reactive signals, guards, async invokes, and persistence."
    link: /clockwork/
