---
title: 'Wired Examples — Lifetimes'
description: 'Lifetimes example for @vielzeug/wired.'
---
...
Set `lifetime` in `factory()` options to control when Wired creates a new instance. The default is `'singleton'`.
