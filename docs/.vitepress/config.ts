          ...
          items: [
            {
              ...
              items: [
                ...
                { link: '/toolkit/examples/array/sortBy', text: 'sortBy' },
            ...
            },
            {
              ...
              items: [
                ...
                { link: '/toolkit/examples/function/attempt', text: 'attempt' },
                ...
                { link: '/toolkit/examples/function/delay', text: 'delay' },
                ...
                { link: '/toolkit/examples/function/predict', text: 'predict' },
                { link: '/toolkit/examples/function/proxy', text: 'proxy' },
                { link: '/toolkit/examples/function/retry', text: 'retry' },
                { link: '/toolkit/examples/function/sleep', text: 'sleep' },
            ...
            },
            {
              collapsed: false,
              items: [
                { link: '/toolkit/examples/typed/is.md', text: 'is' },
                { link: '/toolkit/examples/typed/gt.md', text: 'gt' },
                { link: '/toolkit/examples/typed/ge.md', text: 'ge' },
                { link: '/toolkit/examples/typed/lt.md', text: 'lt' },
                { link: '/toolkit/examples/typed/le.md', text: 'le' },
                { link: '/toolkit/examples/typed/isArray.md', text: 'isArray' },
                { link: '/toolkit/examples/typed/isBoolean.md', text: 'isBoolean' },
                { link: '/toolkit/examples/typed/isDate.md', text: 'isDate' },
                { link: '/toolkit/examples/typed/isDefined.md', text: 'isDefined' },
                { link: '/toolkit/examples/typed/isEmpty.md', text: 'isEmpty' },
                { link: '/toolkit/examples/typed/isEqual.md', text: 'isEqual' },
                { link: '/toolkit/examples/typed/isEven.md', text: 'isEven' },
                { link: '/toolkit/examples/typed/isFunction.md', text: 'isFunction' },
                { link: '/toolkit/examples/typed/isMatch.md', text: 'isMatch' },
                { link: '/toolkit/examples/typed/isNegative.md', text: 'isNegative' },
                { link: '/toolkit/examples/typed/isNil.md', text: 'isNil' },
                { link: '/toolkit/examples/typed/isNumber.md', text: 'isNumber' },
                { link: '/toolkit/examples/typed/isObject.md', text: 'isObject' },
                { link: '/toolkit/examples/typed/isOdd.md', text: 'isOdd' },
                { link: '/toolkit/examples/typed/isPositive.md', text: 'isPositive' },
                { link: '/toolkit/examples/typed/isPrimitive.md', text: 'isPrimitive' },
                { link: '/toolkit/examples/typed/isPromise.md', text: 'isPromise' },
                { link: '/toolkit/examples/typed/isRegex.md', text: 'isRegex' },
                { link: '/toolkit/examples/typed/isString.md', text: 'isString' },
                { link: '/toolkit/examples/typed/isWithin.md', text: 'isWithin' },
                { link: '/toolkit/examples/typed/isZero.md', text: 'isZero' },
              ],
