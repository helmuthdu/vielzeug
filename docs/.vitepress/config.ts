      ...
      '/fetchit/': [
        { link: '/fetchit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/fetchit/usage#prefetch-options', text: 'Prefetch' },
      ...
      '/formit/': [
        { link: '/formit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/formit/usage#reset-and-replace', text: 'Reset and Replace' },
        ...
        },
        {
          items: [
            ...
            { link: '/formit/api#error-store', text: 'Error Store' },
      ...
      '/i18nit/': [
        { link: '/i18nit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/i18nit/usage#lifecycle', text: 'Lifecycle' },
      ...
      '/routeit/': [
        { link: '/routeit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/routeit/usage#lifecycle', text: 'Lifecycle' },
          ],
          link: '/routeit/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/routeit/api', text: 'createRouter()' },
            { link: '/routeit/api', text: 'defineRoutes()' },
            { link: '/routeit/api#route-table-shape', text: 'Route Table Shape' },
      ...
      '/validit/': [
        { link: '/validit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/validit/usage#v-namespace-factories', text: 'v Namespace' },
            { link: '/validit/usage#primitive-schemas', text: 'Primitives' },
            { link: '/validit/usage#complex-schemas', text: 'Complex Schemas' },
            { link: '/validit/usage#validation-methods', text: 'Validation Methods' },
            { link: '/validit/usage#nullability-and-defaults', text: 'Nullability & Defaults' },
            { link: '/validit/usage#refinements', text: 'Refinements' },
            { link: '/validit/usage#transform-and-preprocess', text: 'Transform & Preprocess' },
            { link: '/validit/usage#object-composition-and-unknown-keys', text: 'Object Composition' },
        ...
        },
        {
          items: [
            ...
            { link: '/validit/api#union-and-intersection', text: 'Union & Intersection' },
