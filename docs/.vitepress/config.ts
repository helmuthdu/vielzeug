  ...
  themeConfig: {
    ...
    sidebar: makePackageSidebarsCollapsible({
      ...
      '/codex/': [
        ...
        { link: '/codex/tools', text: 'MCP Tools' },
      ],
      '/coins/': [
      ...
      '/gesture/': [
        { link: '/gesture/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/gesture/usage#completion-rules', text: 'Completion Rules' },
            { link: '/gesture/usage#direction-recognition', text: 'Direction Recognition' },
            { link: '/gesture/usage#pointer-capture', text: 'Pointer Capture' },
            { link: '/gesture/usage#interactive-descendants', text: 'Interactive Descendants' },
            { link: '/gesture/usage#disabled-state', text: 'Disabled State' },
      ...
      '/mesh/': [
        { link: '/mesh/', text: 'Overview' },
        {
          items: [
            { link: '/mesh/usage#basic-usage', text: 'Basic Usage' },
            { link: '/mesh/usage#pairing-flow', text: 'Pairing Flow' },
            { link: '/mesh/usage#sending-and-receiving', text: 'Sending & Receiving' },
            { link: '/mesh/usage#peer-lifecycle', text: 'Peer Lifecycle' },
            { link: '/mesh/usage#timeouts-and-limits', text: 'Timeouts & Limits' },
            { link: '/mesh/usage#security-model', text: 'Security Model' },
            { link: '/mesh/usage#testing', text: 'Testing' },
            { link: '/mesh/usage#framework-integration', text: 'Framework Integration' },
            { link: '/mesh/usage#working-with-other-vielzeug-libraries', text: 'Vielzeug Integration' },
            { link: '/mesh/usage#best-practices', text: 'Best Practices' },
          ],
          link: '/mesh/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/mesh/api#api-overview', text: 'Overview' },
            { link: '/mesh/api#package-entry-point', text: 'Entry Point' },
            { link: '/mesh/api#createmeshhost', text: 'createMeshHost()' },
            { link: '/mesh/api#createmeshguest', text: 'createMeshGuest()' },
            { link: '/mesh/api#codec', text: 'Codec' },
            { link: '/mesh/api#types', text: 'Types' },
            { link: '/mesh/api#errors', text: 'Errors' },
          ],
          link: '/mesh/api',
          text: 'API Reference',
        },
      ...
      '/necromancer/': [
        ...
        { link: '/necromancer/migration', text: 'Migration' },
        {
          items: [
      ...
      '/ore/': [
        ...
        { link: '/ore/migration', text: 'Migration' },
        {
          ...
          items: [
            ...
            { link: '/ore/usage#sentinel-observers', text: 'Sentinel' },
        ...
        },
        {
          items: [
            ...
            { link: '/ore/examples/observers-in-onmount', text: 'Sentinels in onMounted()' },
      ...
      '/postmaster/': [
        ...
        { link: '/postmaster/migration', text: 'Migration' },
        {
          items: [
            ...
            { link: '/postmaster/usage#postmaster-jobs-vs-courier-requests', text: 'Jobs vs Courier' },
            { link: '/postmaster/usage#payload-and-version-migration', text: 'Migration' },
            { link: '/postmaster/usage#corrupt-persisted-records', text: 'Corrupt Records' },
        ...
        {
          items: [
            { link: '/postmaster/examples/queue-offline-courier-mutations', text: 'Offline Requests' },
      ...
      '/prism/': [
        ...
        { link: '/prism/migration', text: 'Migration' },
        {
          items: [
            ...
            { link: '/prism/usage#updating-data', text: 'Updating Data' },
        ...
        },
        {
          items: [
            ...
            { link: '/prism/examples/update-data', text: 'Update Data' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { link: '/refine/components/keyboard-key', text: 'Keyboard Key' },
                ...
                { link: '/refine/components/qr-code', text: 'QR Code' },
            ...
            },
            {
              ...
              items: [
                ...
                { link: '/refine/components/counter', text: 'Counter' },
                ...
                { link: '/refine/components/qr-scanner', text: 'QR Scanner' },
      ...
      '/ripple/': [
        ...
        },
        {
          items: [
            ...
            { link: '/ripple/api#watch-and-observability', text: 'Watch and Observability' },
        ...
        },
        {
          items: [
            ...
            { link: '/ripple/examples/immutable-store', text: 'Immutable State' },
      ...
      '/sentinel/': [
        { link: '/sentinel/', text: 'Overview' },
        { link: '/sentinel/migration', text: 'Migration' },
        {
          items: [
            { link: '/sentinel/usage#basic-usage', text: 'Basic Usage' },
            { link: '/sentinel/usage#observe-window-state', text: 'Window State' },
            { link: '/sentinel/usage#observe-media-queries', text: 'Media Queries' },
            { link: '/sentinel/usage#observe-elements', text: 'Elements' },
            { link: '/sentinel/usage#control-ownership', text: 'Ownership' },
            { link: '/sentinel/usage#handle-unavailable-apis', text: 'Unavailable APIs' },
            { link: '/sentinel/usage#framework-integration', text: 'Framework Integration' },
            {
              link: '/sentinel/usage#working-with-other-vielzeug-libraries',
              text: 'Vielzeug Integration',
            },
            { link: '/sentinel/usage#best-practices', text: 'Best Practices' },
          ],
          link: '/sentinel/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/sentinel/api#api-overview', text: 'Overview' },
            { link: '/sentinel/api#package-entry-point', text: 'Entry Point' },
            { link: '/sentinel/api#factories', text: 'Factories' },
            { link: '/sentinel/api#types', text: 'Types' },
            { link: '/sentinel/api#errors', text: 'Errors' },
          ],
          link: '/sentinel/api',
          text: 'API Reference',
        },
        {
          items: [
            { link: '/sentinel/examples/responsive-viewport-tracking', text: 'Viewport Tracking' },
            { link: '/sentinel/examples/monitor-network-condition', text: 'Network Monitoring' },
            { link: '/sentinel/examples/respect-reduced-motion-preference', text: 'Reduced Motion' },
            { link: '/sentinel/examples/responsive-column-layout', text: 'Responsive Layout' },
            { link: '/sentinel/examples/lazy-load-images-on-intersection', text: 'Lazy Loading' },
          ],
          link: '/sentinel/examples',
          text: 'Examples',
        },
      ],
      '/sigil/': [
        { link: '/sigil/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/sigil/usage#encoding-modes-and-capacity', text: 'Modes & Capacity' },
            { link: '/sigil/usage#error-correction', text: 'Error Correction' },
            { link: '/sigil/usage#rendering', text: 'Rendering' },
            { link: '/sigil/usage#scanning-browser-only', text: 'Scanning' },
            { link: '/sigil/usage#testing', text: 'Testing' },
            { link: '/sigil/usage#framework-integration', text: 'Framework Integration' },
            {
              link: '/sigil/usage#working-with-other-vielzeug-libraries',
              text: 'Vielzeug Integration',
            },
        ...
        {
          items: [
            { link: '/sigil/api#api-overview', text: 'Overview' },
            { link: '/sigil/api#package-entry-point', text: 'Entry Point' },
            { link: '/sigil/api#encoding', text: 'Encoding' },
            { link: '/sigil/api#rendering', text: 'Rendering' },
            { link: '/sigil/api#scanning-browser-only', text: 'Scanning' },
            { link: '/sigil/api#types', text: 'Types' },
            { link: '/sigil/api#errors', text: 'Errors' },
          ],
          link: '/sigil/api',
          text: 'API Reference',
        },
      ...
      '/tempo/': [
        ...
        { link: '/tempo/migration', text: 'Migration' },
        {
          items: [
            { link: '/tempo/usage#basic-usage', text: 'Basic Usage' },
            { link: '/tempo/usage#parse-iso-values', text: 'Parse ISO Values' },
            { link: '/tempo/usage#convert-timezones', text: 'Convert Timezones' },
            { link: '/tempo/usage#calculate-and-compare', text: 'Calculate and Compare' },
            { link: '/tempo/usage#classify-expiry', text: 'Classify Expiry' },
            { link: '/tempo/usage#format-values', text: 'Format Values' },
            { link: '/tempo/usage#generate-calendar-sequences', text: 'Calendar Sequences' },
            { link: '/tempo/usage#testing', text: 'Testing' },
        ...
        },
        {
          items: [
            ...
            { link: '/tempo/api#arithmetic-and-comparison', text: 'Arithmetic and Comparison' },
            { link: '/tempo/api#calendar-sequences', text: 'Calendar Sequences' },
            { link: '/tempo/api#formatting', text: 'Formatting' },
            { link: '/tempo/api#classification', text: 'Classification' },
            { link: '/tempo/api#types', text: 'Types' },
            { link: '/tempo/api#errors', text: 'Errors' },
          ],
          link: '/tempo/api',
          text: 'API Reference',
        },
      ...
      '/vault/': [
        ...
        },
        {
          items: [
            ...
            { link: '/vault/api#store-capabilities', text: 'Store capabilities' },
      ...
      '/ward/': [
        ...
        { link: '/ward/migration', text: 'Migration' },
        {
          items: [
            { link: '/ward/usage#basic-usage', text: 'Basic Usage' },
            { link: '/ward/usage#explain-a-decision', text: 'Explain a Decision' },
            { link: '/ward/usage#batch-decisions', text: 'Batch Decisions' },
            { link: '/ward/usage#bound-ward-foruser', text: 'Bound Ward' },
            { link: '/ward/usage#allowed-actions', text: 'Allowed Actions' },
            { link: '/ward/usage#rule-introspection', text: 'Rule Introspection' },
            { link: '/ward/usage#trace-candidates', text: 'Trace Candidates' },
            { link: '/ward/usage#predicate-helpers', text: 'Predicate Helpers' },
            { link: '/ward/usage#request-guards', text: 'Request Guards' },
            { link: '/ward/usage#testing', text: 'Testing' },
        ...
        },
        {
          items: [
            ...
            { link: '/ward/api#tap-handler-options', text: 'tap()' },
          ],
          link: '/ward/api',
          text: 'API Reference',
        },
