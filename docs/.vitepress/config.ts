  ...
  themeConfig: {
    ...
    sidebar: makePackageSidebarsCollapsible({
      ...
      '/codex/': [
        ...
        {
          items: [
            { link: '/codex/usage#running-the-server', text: 'Running the Server' },
            { link: '/codex/usage#client-setup', text: 'Client Setup' },
            { link: '/codex/usage#http-mode', text: 'HTTP Mode' },
            { link: '/codex/usage#recommended-tool-workflow', text: 'Tool Workflow' },
            { link: '/codex/usage#programmatic-embedding', text: 'Programmatic Embedding' },
            { link: '/codex/usage#security-notes', text: 'Security Notes' },
            { link: '/codex/usage#pinning-a-version', text: 'Pinning a Version' },
