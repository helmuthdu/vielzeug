  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/stateit/': [
        ...
        {
          items: [
            { link: '/stateit/usage#installation', text: 'Installation' },
            { link: '/stateit/usage#state-creation', text: 'State Creation' },
            { link: '/stateit/usage#reading-state', text: 'Reading State' },
            { link: '/stateit/usage#updating-state', text: 'Updating State' },
            { link: '/stateit/usage#subscriptions', text: 'Subscriptions' },
            { link: '/stateit/usage#scoped-states', text: 'Scoped States' },
            { link: '/stateit/usage#async-state-updates', text: 'Async Updates' },
            { link: '/stateit/usage#testing', text: 'Testing' },
            { link: '/stateit/usage#advanced-patterns', text: 'Advanced Patterns' },
          ],
          link: '/stateit/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/stateit/api#types', text: 'Types' },
            { link: '/stateit/api#factory-function', text: 'createState()' },
            { link: '/stateit/api#state-class', text: 'State Class' },
            { link: '/stateit/api#utility-functions', text: 'Utility Functions' },
            { link: '/stateit/api#testing-helpers', text: 'Testing Helpers' },
          ],
          link: '/stateit/api',
          text: 'API Reference',
        },
