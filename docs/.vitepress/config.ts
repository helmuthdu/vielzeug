  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/craftit/': [
        { link: '/craftit/', text: 'Overview' },
        {
          ...
          items: [
            ...
            { link: '/craftit/usage#template-system', text: 'Templates' },
            { link: '/craftit/usage#control-flow', text: 'Control Flow' },
            { link: '/craftit/usage#element-references', text: 'Refs' },
            { link: '/craftit/usage#lifecycle-hooks', text: 'Lifecycle' },
            { link: '/craftit/usage#aria-accessibility', text: 'Accessibility' },
            { link: '/craftit/usage#platform-observers', text: 'Observers' },
            { link: '/craftit/usage#props-and-attributes', text: 'Props' },
            { link: '/craftit/usage#slots', text: 'Slots & Emits' },
            { link: '/craftit/usage#context-dependency-injection', text: 'Context / DI' },
            { link: '/craftit/usage#form-integration', text: 'Forms' },
            { link: '/craftit/usage#styling', text: 'Styling' },
            { link: '/craftit/usage#testing', text: 'Testing' },
          ],
          link: '/craftit/usage',
          text: 'Usage Guide',
        },
        {
          collapsed: true,
          items: [
            { link: '/craftit/api#core-functions', text: 'define()' },
            { link: '/craftit/api#signals-1', text: 'Signals' },
            { link: '/craftit/api#template-system', text: 'Templates' },
            { link: '/craftit/api#styling', text: 'Styling' },
            { link: '/craftit/api#lifecycle', text: 'Lifecycle' },
            { link: '/craftit/api#props-context', text: 'Props & Context' },
            { link: '/craftit/api#utilities', text: 'Utilities' },
            { link: '/craftit/api#platform-observers', text: 'Observers' },
            { link: '/craftit/api#accessibility-focus', text: 'Accessibility' },
            { link: '/craftit/api#context-helpers', text: 'Context Helpers' },
            { link: '/craftit/api#testing-utilities', text: 'Testing' },
      ...
      '/dragit/': [
        ...
        { link: '/dragit/examples', text: 'Examples' },
      ],
      '/eventit/': [
      ...
      '/stateit/': [
        { link: '/stateit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/stateit/usage#nextvalue-async-watch', text: 'nextValue' },
            ...
            { link: '/stateit/usage#symboldispose-using-declarations', text: 'using Declarations' },
      ...
      '/virtualit/': [
        ...
        {
          items: [
            { link: '/virtualit/usage#import', text: 'Import' },
        ...
        {
          items: [
            { link: '/virtualit/api#createvirtualizer-el-options', text: 'createVirtualizer()' },
        ...
        { link: '/virtualit/examples', text: 'Examples' },
      ],
      '/wireit/': [
        { link: '/wireit/', text: 'Overview' },
        {
          items: [
            { link: '/wireit/usage#why-wireit', text: 'Why Wireit?' },
      ...
      '/workit/': [
        { link: '/workit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/workit/usage#symboldispose-using-declarations', text: 'using Declarations' },
