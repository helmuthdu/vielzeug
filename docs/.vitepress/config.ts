      ...
      '/lingua/': [
        { link: '/lingua/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/lingua/usage#bound-plural-functions', text: 'Bound Plural Functions' },
        ...
        },
        {
          items: [
            ...
            { link: '/lingua/api#bindplural', text: 'bindPlural()' },
      ...
      '/ripple/': [
        { link: '/ripple/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/ripple/usage#batching-store-mutations', text: 'Batching' },
            { link: '/ripple/usage#signal-combinators', text: 'Combinators' },
