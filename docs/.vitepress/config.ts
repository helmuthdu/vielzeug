      ...
      '/snapit/': [
        { link: '/snapit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/snapit/usage#subscriptions', text: 'Subscriptions' },
            { link: '/snapit/usage#scoped-states', text: 'Scoped States' },
            { link: '/snapit/usage#async-state-updates', text: 'Async Updates' },
            { link: '/snapit/usage#testing', text: 'Testing' },
            { link: '/snapit/usage#advanced-patterns', text: 'Advanced Patterns' },
          ],
          link: '/snapit/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/snapit/api#types', text: 'Types' },
            { link: '/snapit/api#factory-function', text: 'createSnapshot()' },
            { link: '/snapit/api#state-class', text: 'State Class' },
            { link: '/snapit/api#utility-functions', text: 'Utility Functions' },
            { link: '/snapit/api#testing-helpers', text: 'Testing Helpers' },
          ],
          link: '/snapit/api',
          text: 'API Reference',
        },
        { link: '/snapit/examples', text: 'Examples' },
      ],
      '/toolkit/': [
  ...
  vite: {
    resolve: {
      alias: {
        ...
        '@vielzeug/snapit': resolve(__dirname, '../../packages/snapit/src'),
