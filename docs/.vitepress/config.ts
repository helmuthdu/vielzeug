...
async function generateLlmsTxt(siteConfig: { outDir: string }): Promise<void> {
  ...
  const llmsTxt = [
    ...
    '- [Building a Typed Form Flow](/guide/building-a-typed-form-flow): Spell + Forge + Courier',
    '- [State and Routing](/guide/state-and-routing): Ripple + Wayfinder',
  ].join('\n');
          ...
          items: [
...

            {
              ...
              items: [
                ...
                { link: '/arsenal/examples/function/configure', text: 'partial' },
                ...
                { link: '/arsenal/examples/function/negate', text: 'negate' },
            ...
            },
            {
              collapsed: true,
              items: [
                { link: '/arsenal/examples/typed/is', text: 'is' },
                { link: '/arsenal/examples/typed/isArray', text: 'is.array' },
                { link: '/arsenal/examples/typed/isBoolean', text: 'is.boolean' },
                { link: '/arsenal/examples/typed/isDate', text: 'is.date' },
                { link: '/arsenal/examples/typed/isDefined', text: 'is.defined' },
                { link: '/arsenal/examples/typed/isEmpty', text: 'is.empty' },
                { link: '/arsenal/examples/typed/isEqual', text: 'is.equal' },
                { link: '/arsenal/examples/typed/isFunction', text: 'is.fn' },
                { link: '/arsenal/examples/typed/isGreaterThan', text: 'isGreaterThan' },
                { link: '/arsenal/examples/typed/isGreaterThanOrEqual', text: 'isGreaterThanOrEqual' },
                { link: '/arsenal/examples/typed/isLessThan', text: 'isLessThan' },
                { link: '/arsenal/examples/typed/isLessThanOrEqual', text: 'isLessThanOrEqual' },
                { link: '/arsenal/examples/typed/isMatch', text: 'is.match' },
                { link: '/arsenal/examples/typed/isNil', text: 'is.nil' },
                { link: '/arsenal/examples/typed/isNumber', text: 'is.number' },
                { link: '/arsenal/examples/typed/isObject', text: 'is.object' },
                { link: '/arsenal/examples/typed/isPrimitive', text: 'is.primitive' },
                { link: '/arsenal/examples/typed/isPromise', text: 'is.promise' },
                { link: '/arsenal/examples/typed/isRegex', text: 'is.regex' },
                { link: '/arsenal/examples/typed/isString', text: 'is.string' },
                { link: '/arsenal/examples/typed/isWithin', text: 'isWithin' },
                { link: '/arsenal/examples/typed/typeOf', text: 'is.typeOf' },
              ],
      ...
      '/spell/': [
        { link: '/spell/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/spell/usage#schema-factories', text: 'Schema Factories' },
            { link: '/spell/usage#primitive-schemas', text: 'Primitives' },
            { link: '/spell/usage#objects-arrays-tuples-and-records', text: 'Objects and Collections' },
            { link: '/spell/usage#union-intersect-and-variant', text: 'Union, Intersect, and Variant' },
            { link: '/spell/usage#parsing-and-validation-flow', text: 'Parsing Flow' },
            { link: '/spell/usage#optional-nullable-default-and-catch', text: 'Optional, Default, and Catch' },
            { link: '/spell/usage#transforms-preprocess-and-branding', text: 'Transforms and Preprocess' },
            { link: '/spell/usage#async-validation', text: 'Async Validation' },
            { link: '/spell/usage#error-handling', text: 'Error Handling' },
            { link: '/spell/usage#message-customization', text: 'Message Customization' },
            { link: '/spell/usage#type-inference', text: 'Type Inference' },
        ...
        {
          items: [
            { link: '/spell/api#most-used-first', text: 'Most Used First' },
            { link: '/spell/api#package-exports', text: 'Package Exports' },
            { link: '/spell/api#v-namespace', text: 'v Namespace' },
            { link: '/spell/api#schema', text: 'Schema' },
            { link: '/spell/api#stringschema', text: 'StringSchema' },
            { link: '/spell/api#numberschema', text: 'NumberSchema' },
            { link: '/spell/api#dateschema', text: 'DateSchema' },
            { link: '/spell/api#arrayschema', text: 'ArraySchema' },
            { link: '/spell/api#objectschema', text: 'ObjectSchema' },
            { link: '/spell/api#tupleschema', text: 'TupleSchema' },
            { link: '/spell/api#recordschema', text: 'RecordSchema' },
            { link: '/spell/api#unionschema', text: 'UnionSchema' },
            { link: '/spell/api#intersectschema', text: 'IntersectSchema' },
            { link: '/spell/api#variantschema', text: 'VariantSchema' },
            { link: '/spell/api#global-messages', text: 'Global Messages' },
        ...
        {
          items: [
            { link: '/spell/examples/forms', text: 'Forms' },
            { link: '/spell/examples/api', text: 'API' },
            { link: '/spell/examples/async', text: 'Async' },
            { link: '/spell/examples/unions', text: 'Unions & Variant' },
          ],
          link: '/spell/examples',
          text: 'Examples',
        },
