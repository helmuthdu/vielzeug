      ...
      '/ledger/': [
        { link: '/ledger/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/ledger/usage#composing-commands', text: 'Composing Commands' },
            { link: '/ledger/usage#concurrent-safety', text: 'Concurrent Safety' },
            { link: '/ledger/usage#history-cap', text: 'History Cap' },
            { link: '/ledger/usage#custom-command-data', text: 'Custom Command Data' },
            { link: '/ledger/usage#error-handling', text: 'Error Handling' },
            { link: '/ledger/usage#cancellation', text: 'Cancellation' },
        ...
        },
        {
          items: [
            ...
            { link: '/ledger/api#createledger-options', text: 'createLedger()' },
            { link: '/ledger/api#ledger', text: 'Ledger' },
            { link: '/ledger/api#command', text: 'Command' },
            { link: '/ledger/api#ledgeroptions', text: 'LedgerOptions' },
            { link: '/ledger/api#ledgercalloptions', text: 'LedgerCallOptions' },
            { link: '/ledger/api#compose-commands-label', text: 'compose()' },
      ...
      '/vault/': [
        { link: '/vault/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/vault/usage#lazy-iteration-indexeddb-memory', text: 'Lazy Iteration' },
        ...
        },
        {
          items: [
            ...
            { link: '/vault/api#memoryadapter', text: 'MemoryAdapter' },
