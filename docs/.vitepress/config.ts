      ...
      '/deposit/': [
        { link: '/deposit/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/deposit/usage#reactive-reads', text: 'Reactive Reads' },
            { link: '/deposit/usage#batch-writes', text: 'Batch Writes' },
            { link: '/deposit/usage#plugins', text: 'Plugins' },
            { link: '/deposit/usage#framework-integration', text: 'Framework Integration' },
            { link: '/deposit/usage#best-practices', text: 'Best Practices' },
          ],
          link: '/deposit/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/deposit/api#api-at-a-glance', text: 'At a Glance' },
            ...
            { link: '/deposit/api#indexeddbadapter', text: 'IndexedDbAdapter' },
            ...
            { link: '/deposit/api#errors', text: 'Errors' },
          ],
          link: '/deposit/api',
          text: 'API Reference',
        },
        {
          items: [
            { link: '/deposit/examples/crud', text: 'CRUD' },
            { link: '/deposit/examples/querying', text: 'Querying' },
            { link: '/deposit/examples/ttl', text: 'TTL and Pruning' },
            { link: '/deposit/examples/reactive', text: 'Reactive Tables' },
            { link: '/deposit/examples/batch', text: 'Batch Writes' },
            { link: '/deposit/examples/iterate', text: 'Lazy Iteration' },
            { link: '/deposit/examples/plugins', text: 'Plugins and Error Handling' },
          ],
      ...
      '/grip/': [
        ...
        },
        {
          items: [
            ...
            { link: '/grip/examples/web-component-with-craftit', text: 'Web Component with craft' },
          ],
          link: '/grip/examples',
          text: 'Examples',
        },
      ...
      '/relay/': [
        { link: '/relay/', text: 'Overview' },
        {
          items: [
            ...
            { link: '/relay/usage#event-piping', text: 'Event Piping' },
            { link: '/relay/usage#debug-mode', text: 'Debug Mode' },
        ...
        },
        {
          items: [
            ...
            { link: '/relay/examples/bus-bridging-with-pipeevents', text: 'Bus bridging with pipeEvents()' },
      ...
      '/sourcerer/': [
        ...
        },
        {
          items: [
            ...
            { link: '/sourcerer/examples/sourceit-with-stateit', text: 'Reactive Controls with Ripple' },
            { link: '/sourcerer/examples/sourceit-with-fetchit', text: 'Remote Data with Courier' },
            { link: '/sourcerer/examples/sourceit-with-routeit', text: 'URL-Synced List with Route' },
          ],
