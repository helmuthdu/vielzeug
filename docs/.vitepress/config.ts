  ...
  themeConfig: {
    ...
    sidebar: makePackageSidebarsCollapsible({
      ...
      '/fetchit/': [
        ...
        {
          items: [
            { link: '/fetchit/usage#unified-client', text: 'Unified Client' },
            ...
            { link: '/fetchit/usage#mutation', text: 'Mutations' },
            { link: '/fetchit/usage#server-sent-events', text: 'Server-Sent Events' },
            { link: '/fetchit/usage#http-streaming', text: 'HTTP Streaming' },
            { link: '/fetchit/usage#framework-store-integration', text: 'Framework Integration' },
        ...
        {
          items: [
            { link: '/fetchit/api#createfetchit', text: 'createFetchit()' },
            ...
            { link: '/fetchit/api#createstream', text: 'createStream()' },
        ...
        {
          items: [
            { link: '/fetchit/examples/ai-token-stream', text: 'AI Token Stream' },
            ...
            { link: '/fetchit/examples/sse-events', text: 'SSE Events' },
          ],
      ...
      '/machinit/': [
        { link: '/machinit/', text: 'Overview' },
        {
          items: [
            { link: '/machinit/usage#basic-usage', text: 'Basic Usage' },
            { link: '/machinit/usage#transitions-and-guards', text: 'Transitions & Guards' },
            { link: '/machinit/usage#actions', text: 'Actions' },
            { link: '/machinit/usage#entry-and-exit-actions', text: 'Entry & Exit Actions' },
            { link: '/machinit/usage#async-invokes', text: 'Async Invokes' },
            { link: '/machinit/usage#context-validation', text: 'Context Validation' },
            { link: '/machinit/usage#persistence', text: 'Persistence' },
            { link: '/machinit/usage#debugging-and-tracing', text: 'Debugging & Tracing' },
            { link: '/machinit/usage#testing', text: 'Testing' },
            { link: '/machinit/usage#disposal', text: 'Disposal' },
            { link: '/machinit/usage#common-patterns', text: 'Common Patterns' },
            { link: '/machinit/usage#best-practices', text: 'Best Practices' },
          ],
          link: '/machinit/usage',
          text: 'Usage Guide',
        },
        {
          items: [
            { link: '/machinit/api#api-at-a-glance', text: 'At a Glance' },
            { link: '/machinit/api#definitions', text: 'defineMachine()' },
            { link: '/machinit/api#interpret', text: 'interpret()' },
            { link: '/machinit/api#resolvetransition', text: 'resolveTransition()' },
            { link: '/machinit/api#assign', text: 'assign()' },
            { link: '/machinit/api#types', text: 'Types' },
            { link: '/machinit/api#signals-and-reactivity', text: 'Signals & Reactivity' },
          ],
          link: '/machinit/api',
          text: 'API Reference',
        },
        {
          items: [
            { link: '/machinit/examples/form-validation', text: 'Form with Validation' },
            { link: '/machinit/examples/media-player', text: 'Media Player' },
            { link: '/machinit/examples/fetch-retry', text: 'Fetch with Retry' },
            { link: '/machinit/examples/checkout', text: 'Shopping Cart Checkout' },
            { link: '/machinit/examples/wizard-with-routing', text: 'Multi-Step Wizard with Routing' },
            { link: '/machinit/examples/paginated-data-loading', text: 'Paginated Data Loading with Search' },
            { link: '/machinit/examples/permission-based-access', text: 'Permission-Based Access Control' },
            { link: '/machinit/examples/multi-machine-coordination', text: 'Multi-Machine Coordination with Events' },
          ],
          link: '/machinit/examples',
          text: 'Examples',
        },
      ],
      '/mcpit/': [
  ...
  vite: {
    ...
    resolve: {
      alias: {
        ...
        '@vielzeug/machinit': resolve(__dirname, '../../packages/machinit/src'),
