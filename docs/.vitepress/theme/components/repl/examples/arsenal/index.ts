import { arrayChunkExample } from './array-chunk';
import { arrayFilterExample } from './array-filter';
...
export const arsenalExamples = {
  'array-chunk': arrayChunkExample,
  'array-filter': arrayFilterExample,
