...
const LIBRARY_LOADERS = {
  ...
  orbit: async () => {
    const [main, presetsModule] = await Promise.all([
      import('@vielzeug/orbit'),
      import('@vielzeug/orbit/presets'),
    ]);
...
const LIBRARY_EXPORTS = {
  ...
  arsenal: [
    ...
    'abortable', 'attempt', 'defer', 'parallel', 'queue', 'retry', 'sleep', 'timeout', 'waitFor', 'Scheduler', 'polyfillScheduler',
    'assert', 'assertAll', 'allOf', 'anyOf', 'noneOf', 'compare', 'compareBy', 'compose', 'constant',
    'curry', 'debounce', 'identity', 'memo', 'once', 'partial', 'pipe', 'tap', 'throttle',
    'abs', 'allocate', 'average', 'clamp', 'gcd', 'lcm', 'lerp', 'linspace', 'max', 'median', 'min',
    'mod', 'normalize', 'percent', 'range', 'round', 'standardDeviation', 'sum', 'variance',
    'currency', 'exchange',
    'stash', 'deepClone', 'defaults', 'diff', 'deepMerge', 'shallowMerge', 'entries', 'filterValues',
    'fromEntries', 'get', 'has', 'invert', 'keys', 'mapKeys', 'mapValues', 'omit', 'parseJSON', 'pick', 'prune', 'values',
    'draw', 'random', 'shuffle', 'uuid',
    'camelCase', 'endsWith', 'escape', 'kebabCase', 'pad', 'pascalCase', 'similarity', 'snakeCase',
    'startsWith', 'titleCase', 'truncate', 'unescape', 'words',
    'is', 'isArray', 'isBoolean', 'isDate', 'isDefined', 'isEmpty', 'isEqual', 'isFunction',
