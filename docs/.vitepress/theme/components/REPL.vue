...
const LIBRARY_DESCRIPTIONS = {
  ...
  deposit: 'Type-safe storage (localStorage / IndexedDB) with schemas, TTL, and query building.',
  dragit: 'Framework-agnostic drag-and-drop primitives with file filtering and sortable lists.',
  eventit: 'Strongly-typed publish/subscribe event bus with async support and AbortSignal integration.',
  fetchit: 'Advanced HTTP client with caching, retries, mutations, and request deduplication.',
  floatit: 'Lightweight floating-element positioning for tooltips, popovers, and dropdowns.',
  formit: 'Type-safe form state management with reactive fields and async validation.',
  ...
  stateit: 'Fine-grained reactive state: signals, computed, effects, stores, and more.',
  ...
  workit: 'Web Worker pool abstraction with queuing, timeout, and AbortSignal support.',
} as const;
