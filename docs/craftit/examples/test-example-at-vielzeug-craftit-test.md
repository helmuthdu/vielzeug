---
title: 'Craftit Examples — Test Example (`@vielzeug/craftit/test`)'
description: 'Test Example (`@vielzeug/craftit/test`) examples for craftit.'
---

## Test Example (`@vielzeug/craftit/test`)

## Problem

Implement test example (`@vielzeug/craftit/test`) in a production-friendly way with `@vielzeug/craftit` while keeping setup and cleanup explicit.
