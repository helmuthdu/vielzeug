 ...
 *
 * @throws {ArsenalValidationError} If the first argument is not an array.
 */
...
export function sort<T>(
  ...
  if (!Array.isArray(array)) throw new ArsenalValidationError('sort: first argument must be an array');
