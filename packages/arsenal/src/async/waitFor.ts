 ...
 *
 * // Wait for API to be ready with cancellation support
 * await waitFor(
 *   async (signal) => {
 ...
 * ```
 *
 * @param condition - Polling function that receives the merged AbortSignal and returns true when the condition is met
