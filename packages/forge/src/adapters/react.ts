 ...
 * import { init } from '@vielzeug/forge/react';
 *
...
function requireStore(): UseSyncExternalStoreFn {
  if (!_useSyncExternalStore) {
    throw new Error('[forge/react] Call init(useSyncExternalStore) once at your app entry before using form hooks.');
  }
 ...
 *
 * // SubmitButton.tsx
 * import { useFormState } from '@vielzeug/forge/react';
 *
 ...
 * @example
 * ```tsx
 * import { useField } from '@vielzeug/forge/react';
 *
 ...
 * @example
 * ```tsx
 * import { useFormValues } from '@vielzeug/forge/react';
 *
