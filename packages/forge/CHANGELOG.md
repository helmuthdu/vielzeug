...
- refactor!: adopt flat Standard Schema issues and structural persistence while hardening immutable values, cancellation, submission snapshots, and artifacts
...
- refactor: remove dead _dev.ts, deduplicate isRecord/unsafeKeys in form-data.ts
