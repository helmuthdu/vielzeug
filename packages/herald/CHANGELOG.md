...
- Remove middleware, payload validation, async streams, and bus pipes while retaining fail-late listener errors and simplifying typed lifecycle trace event names.
...
- refactor: remove combineSignals, createSignalScope, createBusInternal from public API. Simplify bus internals.
