...
describe('sg-grid-item', () => {
  ...
  describe('Rendering', () => {
    it('renders grid item element', async () => {
      fixture = await mount('sg-grid-item');

      expect(fixture.element).toBeTruthy();
    });

    it('renders slot content', async () => {
      fixture = await mount('sg-grid-item', { html: '<p>Item</p>' });
...
describe('sg-grid-item accessibility', () => {
  let fixture: Fixture<HTMLElement>;
  ...
  describe('Content Accessibility', () => {
    it('slot content is accessible', async () => {
      fixture = await mount('sg-grid-item', { html: '<h2>Grid heading</h2>' });
