...
/** `sg-code-window` variant */
export type CodeWindowVariant = 'code' | 'chat';

/** `sg-code-window` component properties */
export type SgCodeWindowProps = {
 ...
 * ```
 */
export const CODE_WINDOW_TAG = 'sg-code-window' as const;
define<SgCodeWindowProps>(CODE_WINDOW_TAG, {
  props: {
