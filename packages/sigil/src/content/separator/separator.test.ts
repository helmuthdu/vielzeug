...
describe('sg-separator', () => {
  ...
  describe('Props', () => {
    it('applies orientation attribute on host', async () => {
      fixture = await mount('sg-separator', { attrs: { orientation: 'vertical' } });

      expect(fixture.element.getAttribute('orientation')).toBe('vertical');
    });

    it('applies color attribute on host', async () => {
      fixture = await mount('sg-separator', { attrs: { color: 'primary' } });
  ...
  describe('Edge Cases', () => {
    it('renders without label when label is empty string', async () => {
      fixture = await mount('sg-separator', { attrs: { label: '' } });
...
describe('sg-separator accessibility', () => {
  let fixture: Fixture<HTMLElement>;
  ...
  describe('Semantic Mode (decorative=false)', () => {
    it('hr has role="separator" when not decorative', async () => {
      fixture = await mount('sg-separator', { attrs: { decorative: 'false' } });
    ...
    it('exposes aria-orientation for vertical semantic separator', async () => {
      fixture = await mount('sg-separator', { attrs: { decorative: 'false', orientation: 'vertical' } });
  ...
  describe('Labelled Separator', () => {
    it('label text is visible in DOM', async () => {
      fixture = await mount('sg-separator', { attrs: { label: 'Continue with' } });
