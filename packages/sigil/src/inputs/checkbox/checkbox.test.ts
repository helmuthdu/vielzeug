...
describe('sg-checkbox', () => {
  ...
  describe('Rendering', () => {
    it('renders required shadow DOM elements', async () => {
      fixture = await mount('sg-checkbox');
    ...
    it('renders checkmark and dash icons inside the box', async () => {
      fixture = await mount('sg-checkbox');
      expect(fixture.query('sg-icon[name="check"]')).toBeTruthy();
      expect(fixture.query('sg-icon[name="minus"]')).toBeTruthy();
    });

    it('renders icon state classes expected by the stylesheet', async () => {
      fixture = await mount('sg-checkbox');

      expect(fixture.query('sg-icon.checkmark[name="check"]')).toBeTruthy();
      expect(fixture.query('sg-icon.dash[name="minus"]')).toBeTruthy();
    });
  ...
  describe('Checked State', () => {
    ...
    it('reflects checked attribute when set initially', async () => {
      fixture = await mount('sg-checkbox', { attrs: { checked: true } });
  ...
  describe('Indeterminate State', () => {
    it('reflects indeterminate attribute', async () => {
      fixture = await mount('sg-checkbox', { attrs: { indeterminate: true } });
  ...
  describe('Disabled State', () => {
    it('reflects disabled attribute on host', async () => {
      fixture = await mount('sg-checkbox', { attrs: { disabled: true } });
  ...
  describe('Form Integration', () => {
    it('reflects name attribute', async () => {
      fixture = await mount('sg-checkbox', { attrs: { name: 'terms' } });
      expect(fixture.element.getAttribute('name')).toBe('terms');
    });

    it('reflects value attribute', async () => {
      fixture = await mount('sg-checkbox', { attrs: { value: 'accepted' } });
    ...
    it('updates name dynamically', async () => {
      fixture = await mount('sg-checkbox', { attrs: { name: 'a' } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies color="${color}"`, async () => {
        fixture = await mount('sg-checkbox', { attrs: { color } });
        expect(fixture.element.getAttribute('color')).toBe(color);
      });
    });

    it('updates color dynamically', async () => {
      fixture = await mount('sg-checkbox', { attrs: { color: 'primary' } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies size="${size}"`, async () => {
        fixture = await mount('sg-checkbox', { attrs: { size } });
        expect(fixture.element.getAttribute('size')).toBe(size);
      });
    });

    it('updates size dynamically', async () => {
      fixture = await mount('sg-checkbox', { attrs: { size: 'sm' } });
  ...
  describe('Accessibility', () => {
    ...
    it('sets aria-labelledby when label text is provided', async () => {
      fixture = await mount('sg-checkbox', { html: 'Accept terms' });
...
// Dedicated WAI-ARIA / accessibility spec for sg-checkbox
describe('sg-checkbox accessibility', () => {
  beforeAll(async () => {
    await (() => import('./checkbox'))();
  });
  ...
  describe('Semantic Structure', () => {
    it('has role="checkbox" on the host element', async () => {
      const fixture = await mount('sg-checkbox');
  ...
  describe('WAI-ARIA Attributes', () => {
    ...
    it('has aria-checked="mixed" when indeterminate (partial selection)', async () => {
      const fixture = await mount('sg-checkbox', { attrs: { indeterminate: true } });
    ...
    it('sets aria-labelledby pointing to label span when label text provided', async () => {
      const fixture = await mount('sg-checkbox', { html: 'Remember me' });
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('has no tabindex when disabled (not keyboard-focusable)', async () => {
      const fixture = await mount('sg-checkbox', { attrs: { disabled: true } });
  ...
  describe('Dynamic State Announcements', () => {
    ...
    it('aria-checked transitions from true → false when unchecked', async () => {
      const fixture = await mount('sg-checkbox', { attrs: { checked: true } });
