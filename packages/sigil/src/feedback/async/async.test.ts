...
describe('sg-async', () => {
  ...
  describe('status: loading', () => {
    it('renders the default skeleton stack when no loading slot is provided', async () => {
      fixture = await mount('sg-async', { attrs: { status: 'loading' } });
  ...
  describe('status: empty', () => {
    ...
    it('renders empty state icon', async () => {
      fixture = await mount('sg-async', { attrs: { status: 'empty' } });

      await fixture.flush();
      expect(fixture.query('.region-empty .empty-state .icon sg-icon')).not.toBeNull();
    });
  ...
  describe('status: error', () => {
    ...
    it('does not show retry button by default', async () => {
      fixture = await mount('sg-async', { attrs: { status: 'error' } });

      expect(fixture.query('.retry-btn')).toBeNull();
    });

    it('shows the retry button when retryable is set', async () => {
      fixture = await mount('sg-async', { attrs: { retryable: '', status: 'error' } });
  ...
  describe('status: success', () => {
    ...
    it('sets aria-busy="false" on the host', async () => {
      fixture = await mount('sg-async', { attrs: { status: 'success' } });
