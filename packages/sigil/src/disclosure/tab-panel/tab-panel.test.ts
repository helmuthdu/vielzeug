...
describe('sg-tab-panel', () => {
  ...
  describe('Core Functionality', () => {
    it('renders panel with role tabpanel', async () => {
      fixture = await mount('sg-tab-panel', { attrs: { value: 'overview' }, html: 'Overview body' });
  ...
  describe('Accessibility', () => {
    ...
    it('uses aria-hidden false when active', async () => {
      fixture = await mount('sg-tab-panel', { attrs: { active: '', value: 'overview' }, html: 'Overview body' });
  ...
  describe('Edge Cases', () => {
    it('does not render slot content before first activation in lazy mode', async () => {
      fixture = await mount('sg-tab-panel', { attrs: { lazy: '', value: 'overview' }, html: 'Overview body' });
