 ...
 * import { init } from '@vielzeug/i18nit/react';
 *
 ...
 *
 * // App.tsx
 * import { useI18n } from '@vielzeug/i18nit/react';
 *
 * function App() {
...
export const useI18n = <M extends Messages = Messages>(i18n: I18n<M>): UseI18nReturn<M> => {
  if (!_useSyncExternalStore) {
    throw new Error('[i18nit/react] Call init(useSyncExternalStore) once at your app entry before using useI18n().');
  }
