...
- Remove Ripple-specific signal injection and expose framework-neutral external-store state.
...
- refactor: rename signalFactory option to toSignal across createVirtualizer, createDomVirtualList, createGridVirtualizer, createGroupedVirtualizer. Rename destroyed flag to disposed.
