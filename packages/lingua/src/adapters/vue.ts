 ...
 * import { init } from '@vielzeug/lingua/vue';
 *
 ...
 * import { createI18n, useI18n } from '@vielzeug/lingua/vue';
 *
...
export const useI18n = <M extends Messages = Messages>(i18n: I18n<M>): UseI18nReturn<M> => {
  if (!_onScopeDispose || !_shallowRef) {
    throw new Error(
      '[lingua/vue] Call init({ onScopeDispose, shallowRef }) once at your app entry before using useI18n().',
    );
  }
