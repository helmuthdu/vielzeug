...
- refactor: simplify localization around eager catalogs, atomic locale loading, typed parts, and unified missing-message handling
...
- refactor: remove unused devOnly helper from _dev.ts
