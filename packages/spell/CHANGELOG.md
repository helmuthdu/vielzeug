...
- fix: emit schema marker symbols in published declarations
...
- feat: export SyncParsable, IssuePath, and joinIssuePath for UI adapters
...
- refactor!: simplify the public schema API and add Standard Schema v1 interoperability
