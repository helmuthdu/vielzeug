...
export const createCheckable = (options: CheckableOptions): CheckableHandle => {
  ...
  // on the public handle to decouple the headless primitive from craftit's
