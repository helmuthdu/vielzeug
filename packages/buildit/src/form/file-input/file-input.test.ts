...
describe('bit-file-input', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders error text when provided', async () => {
      fixture = await mount('bit-file-input', { attrs: { error: 'File too large' } });
  ...
  describe('Props', () => {
    ...
    it('applies accept attribute to hidden input', async () => {
      fixture = await mount('bit-file-input', { attrs: { accept: '.pdf,.docx' } });
  ...
  describe('Variants', () => {
    for (const variant of ['solid', 'outlined', 'ghost']) {
  ...
  describe('Events', () => {
    it('dispatches change event when file selected', async () => {
      ...
      Object.defineProperty(input, 'files', { configurable: true, value: { 0: file, item: () => file, length: 1 } });
...
describe('bit-file-input accessibility', () => {
  ...
  describe('Semantic Structure', () => {
    ...
    it('error region has role alert', async () => {
      fixture = await mount('bit-file-input', { attrs: { error: 'Invalid file' } });
