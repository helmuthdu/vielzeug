...
export const componentManifest = [
  ...
  { name: 'button', source: './src/actions/button/button' },
  { name: 'button-group', source: './src/actions/button-group/button-group' },
  { name: 'card', source: './src/content/card/card' },
  { name: 'checkbox', source: './src/form/checkbox/checkbox' },
  { name: 'checkbox-group', source: './src/form/checkbox-group/checkbox-group' },
  { name: 'chip', source: './src/feedback/chip/chip' },
  { name: 'combobox', source: './src/form/combobox/combobox' },
  { name: 'dialog', source: './src/overlay/dialog/dialog' },
  { name: 'drawer', source: './src/overlay/drawer/drawer' },
  { name: 'file-input', source: './src/form/file-input/file-input' },
  { name: 'form', source: './src/form/form/form' },
  { name: 'grid', source: './src/layout/grid/grid' },
  { name: 'grid-item', source: './src/layout/grid-item/grid-item' },
  { name: 'input', source: './src/form/input/input' },
  { name: 'menu', source: './src/overlay/menu/menu' },
  { name: 'number-input', source: './src/form/number-input/number-input' },
  { name: 'otp-input', source: './src/form/otp-input/otp-input' },
  ...
  { name: 'radio', source: './src/form/radio/radio' },
  { name: 'radio-group', source: './src/form/radio-group/radio-group' },
  { name: 'rating', source: './src/form/rating/rating' },
  { name: 'select', source: './src/form/select/select' },
  ...
  { name: 'slider', source: './src/form/slider/slider' },
  { name: 'switch', source: './src/form/switch/switch' },
  ...
  { name: 'textarea', source: './src/form/textarea/textarea' },
