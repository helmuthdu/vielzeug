...
import { EXPORTS, ROOT_EXPORTS, SUBPATH_EXPORTS } from './exports.manifest.mjs';
...
const packageExports = () => {
  ...
  return {
    ...
    ...Object.fromEntries(
      Object.entries(SUBPATH_EXPORTS).map(([subpath, source]) => [`./${subpath}`, sourceEntry(`./src/${source}.ts`)]),
    ),
  };
};
