...
describe('ore-grid-item', () => {
  ...
  describe('Rendering', () => {
    it('renders grid item element', async () => {
      fixture = await mount('ore-grid-item');

      expect(fixture.element).toBeTruthy();
    });

    it('renders slot content', async () => {
      fixture = await mount('ore-grid-item', { html: '<p>Item</p>' });
...
describe('ore-grid-item accessibility', () => {
  let fixture: Fixture<HTMLElement>;
  ...
  describe('Content Accessibility', () => {
    it('slot content is accessible', async () => {
      fixture = await mount('ore-grid-item', { html: '<h2>Grid heading</h2>' });
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      fixture = await mount('ore-grid-item', { html: 'Content' });
