...
describe('ore-chip', () => {
  ...
  describe('Rendering', () => {
    it('renders chip content via slot', async () => {
      fixture = await mount('ore-chip', { html: 'Label' });
    ...
    it('renders remove button in removable mode', async () => {
      fixture = await mount('ore-chip', { attrs: { mode: 'removable' } });
    ...
    it('renders selectable mode as button with checkbox semantics', async () => {
      fixture = await mount('ore-chip', { attrs: { mode: 'selectable' } });
  ...
  describe('Props', () => {
    it('applies color', async () => {
      fixture = await mount('ore-chip', { attrs: { color: 'primary' } });

      expect(fixture.element.getAttribute('color')).toBe('primary');
    });

    it('applies size', async () => {
      fixture = await mount('ore-chip', { attrs: { size: 'lg' } });

      expect(fixture.element.getAttribute('size')).toBe('lg');
    });

    it('applies disabled', async () => {
      fixture = await mount('ore-chip', { attrs: { disabled: '' } });
    ...
    it('applies value', async () => {
      fixture = await mount('ore-chip', { attrs: { value: 'tag-1' } });
  ...
  describe('Removable Mode', () => {
    it('fires remove event when remove button clicked', async () => {
      fixture = await mount('ore-chip', { attrs: { mode: 'removable', value: 'chip-1' } });
    ...
    it('remove event carries value', async () => {
      fixture = await mount('ore-chip', { attrs: { mode: 'removable', value: 'chip-x' } });
    ...
    it('does not emit remove when disabled', async () => {
      fixture = await mount('ore-chip', { attrs: { disabled: '', mode: 'removable', value: 'chip-x' } });
  ...
  describe('Selectable Mode', () => {
    it('toggles unchecked to checked in uncontrolled mode', async () => {
      fixture = await mount('ore-chip', { attrs: { mode: 'selectable', value: 'chip-a' } });
    ...
    it('uses default-checked for initial uncontrolled state', async () => {
      fixture = await mount('ore-chip', { attrs: { 'default-checked': '', mode: 'selectable' } });
    ...
    it('emits change in controlled mode without mutating aria-checked', async () => {
      fixture = await mount('ore-chip', { attrs: { checked: '', mode: 'selectable' } });
    ...
    it('does not emit change when disabled', async () => {
      fixture = await mount('ore-chip', { attrs: { disabled: '', mode: 'selectable' } });
  ...
  describe('Action Mode', () => {
    it('fires click event with detail when action chip clicked', async () => {
      fixture = await mount('ore-chip', { attrs: { mode: 'action', value: 'add' } });
    ...
    it('does not emit click when disabled', async () => {
      fixture = await mount('ore-chip', { attrs: { disabled: '', mode: 'action', value: 'add' } });
  ...
  describe('Disabled State', () => {
    it('remove button is disabled when chip is disabled in removable mode', async () => {
      fixture = await mount('ore-chip', { attrs: { disabled: '', mode: 'removable' } });
  ...
  describe('Colors', () => {
    for (const color of ['primary', 'success', 'warning', 'error', 'info']) {
      it(`applies ${color} color`, async () => {
        fixture = await mount('ore-chip', { attrs: { color } });
...
describe('ore-chip accessibility', () => {
