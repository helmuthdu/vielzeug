...
describe('ore-alert', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders default slot content', async () => {
      fixture = await mount('ore-alert', { html: '<p>Alert message</p>' });

      expect(fixture.element.textContent?.trim()).toBe('Alert message');
    });

    it('renders heading when provided', async () => {
      fixture = await mount('ore-alert', { attrs: { heading: 'Warning!' } });
    ...
    it('dismiss button renders when dismissible', async () => {
      fixture = await mount('ore-alert', { attrs: { dismissible: '' } });
  ...
  describe('ARIA Live Region', () => {
    ...
    it('has aria-live assertive for error color', async () => {
      fixture = await mount('ore-alert', { attrs: { color: 'error' } });
  ...
  describe('Props', () => {
    it('applies color', async () => {
      fixture = await mount('ore-alert', { attrs: { color: 'success' } });
    ...
    it('applies horizontal', async () => {
      fixture = await mount('ore-alert', { attrs: { horizontal: '' } });

      expect(fixture.element.hasAttribute('horizontal')).toBe(true);
    });

    it('applies accented', async () => {
      fixture = await mount('ore-alert', { attrs: { accented: '' } });
...
describe('ore-alert accessibility', () => {
  ...
  describe('Accessibility', () => {
    it('passes axe checks for a status alert', async () => {
      fixture = await mount('ore-alert', { html: '<p>Info message</p>' });
    ...
    it('passes axe checks for a dismissible alert', async () => {
      fixture = await mount('ore-alert', { attrs: { dismissible: '', heading: 'Warning' }, html: '<p>Take note.</p>' });
