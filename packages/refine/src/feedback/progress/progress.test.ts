...
describe('ore-progress', () => {
  ...
  describe('Core Functionality', () => {
    it('renders linear progressbar by default', async () => {
      fixture = await mount('ore-progress', { attrs: { value: '40' } });
    ...
    it('renders circular variant when requested', async () => {
      fixture = await mount('ore-progress', { attrs: { type: 'circular', value: '40' } });
    ...
    it('applies visible fill width in linear determinate mode', async () => {
      fixture = await mount('ore-progress', { attrs: { max: '100', value: '40' } });
  ...
  describe('Accessibility', () => {
    ...
    it('omits valuenow in indeterminate mode for screen readers', async () => {
      fixture = await mount('ore-progress', { attrs: { indeterminate: '', label: 'Loading tasks' } });
    ...
    it('falls back to "Progress" as aria-label when neither label nor title is set', async () => {
      fixture = await mount('ore-progress', { attrs: { value: '50' } });
  ...
  describe('Label', () => {
    it('renders a visible trailing label when label is present without title', async () => {
      fixture = await mount('ore-progress', { attrs: { label: '60%', value: '60' } });
  ...
  describe('Title', () => {
    it('renders title text above the bar', async () => {
      fixture = await mount('ore-progress', { attrs: { title: 'Upload', value: '60' } });
    ...
    it('moves label into the header row when both title and label are set', async () => {
      fixture = await mount('ore-progress', { attrs: { label: '60%', title: 'Upload', value: '60' } });
  ...
  describe('Floating label', () => {
    it('renders the floating chip with the provided text', async () => {
      fixture = await mount('ore-progress', { attrs: { 'floating-label': '60%', value: '60' } });
    ...
    it('floating label is always in the DOM (CSS controls visibility)', async () => {
      fixture = await mount('ore-progress', { attrs: { 'floating-label': '??', indeterminate: '' } });
    ...
    it('track-outer is present as positioning context for floating label', async () => {
      fixture = await mount('ore-progress', { attrs: { 'floating-label': '40%', value: '40' } });
  ...
  describe('Circular label and title', () => {
    it('renders label text inside the ring', async () => {
      fixture = await mount('ore-progress', { attrs: { label: '75%', type: 'circular', value: '75' } });
    ...
    it('renders title text below the label inside the ring', async () => {
      fixture = await mount('ore-progress', {
    ...
    it('falls back to "Progress" as aria-label on circular when neither label nor title is set', async () => {
      fixture = await mount('ore-progress', { attrs: { type: 'circular', value: '75' } });
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      fixture = await mount('ore-progress', { attrs: { label: 'Loading', value: '50' } });
