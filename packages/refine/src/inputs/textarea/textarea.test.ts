...
describe('ore-textarea', () => {
  ...
  describe('Value Management', () => {
    it('sets initial value in textarea', async () => {
      fixture = await mount('ore-textarea', { attrs: { value: 'Hello World' } });
    ...
    it('updates textarea value when attribute changes', async () => {
      fixture = await mount('ore-textarea', { attrs: { value: 'initial' } });
    ...
    it('handles empty string value', async () => {
      fixture = await mount('ore-textarea', { attrs: { value: '' } });
  ...
  describe('Label and Placeholder', () => {
    it('sets name on textarea', async () => {
      fixture = await mount('ore-textarea', { attrs: { name: 'message' } });
  ...
  describe('Disabled State', () => {
    it('disables textarea when disabled', async () => {
      fixture = await mount('ore-textarea', { attrs: { disabled: true } });
  ...
  describe('Readonly State', () => {
    it('sets readOnly on textarea', async () => {
      fixture = await mount('ore-textarea', { attrs: { readonly: true } });
  ...
  describe('Rows and Resize', () => {
    ...
    it('applies no-resize attribute on host', async () => {
      fixture = await mount('ore-textarea', { attrs: { 'no-resize': true } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies ${color} color`, async () => {
        fixture = await mount('ore-textarea', { attrs: { color } });
    ...
    it('updates color dynamically', async () => {
      fixture = await mount('ore-textarea', { attrs: { color: 'primary' } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies ${size} size`, async () => {
        fixture = await mount('ore-textarea', { attrs: { size } });
    ...
    it('updates size dynamically', async () => {
      fixture = await mount('ore-textarea', { attrs: { size: 'sm' } });
  ...
  describe('Edge Cases', () => {
    it('handles fullwidth attribute', async () => {
      fixture = await mount('ore-textarea', { attrs: { fullwidth: true } });

      expect(fixture.element.hasAttribute('fullwidth')).toBe(true);
    });

    it('handles maxlength attribute', async () => {
      fixture = await mount('ore-textarea', { attrs: { maxlength: '100' } });
...
describe('ore-textarea accessibility', () => {
  let fixture: Fixture<HTMLElement>;
