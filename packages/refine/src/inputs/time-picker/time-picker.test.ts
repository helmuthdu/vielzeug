...
describe('ore-time-picker', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders with label prop', async () => {
      fixture = await mount('ore-time-picker', { props: { label: 'Meeting time' } });

      const input = fixture.query('ore-input.trigger');

      expect(input?.getAttribute('label')).toBe('Meeting time');
    });

    it('renders placeholder when no value', async () => {
      fixture = await mount('ore-time-picker', { props: { placeholder: 'Pick a time' } });
    ...
    it('displays formatted time in trigger when value set (24h)', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '09:30' } });
    ...
    it('does not render AM/PM column in 24h mode', async () => {
      fixture = await mount('ore-time-picker', { props: { 'time-format': '24' } });
      await open(fixture);
  ...
  describe('Open / close', () => {
    ...
    it('does not open when disabled', async () => {
      fixture = await mount('ore-time-picker', { props: { disabled: true } });
      await open(fixture);
  ...
  describe('Time selection', () => {
    ...
    it('pre-selects value when reopened', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '14:30' } });
      await open(fixture);
  ...
  describe('min / max bounds', () => {
    it('disables hours before min time', async () => {
      fixture = await mount('ore-time-picker', { props: { min: '10:00' } });
      await open(fixture);
    ...
    it('disables hours after max time', async () => {
      fixture = await mount('ore-time-picker', { props: { max: '17:00' } });
      await open(fixture);
  ...
  describe('Keyboard navigation', () => {
    it('ArrowDown on hour column increments pending hour', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '08:00' } });
      await open(fixture);
    ...
    it('ArrowUp on hour column decrements pending hour', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '10:00' } });
      await open(fixture);
  ...
  describe('Accessibility', () => {
    ...
    it('selected option has aria-selected="true"', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '09:00' } });
      await open(fixture);
  ...
  describe('Disabled state', () => {
    ...
    it('passes disabled attribute to ore-input trigger', async () => {
      fixture = await mount('ore-time-picker', { props: { disabled: true } });
  ...
  describe('Edge cases', () => {
    ...
    it('wraps hour selection from last to first (ArrowDown)', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '23:00' } });
      await open(fixture);
    ...
    it('wraps hour selection from first to last (ArrowUp)', async () => {
      fixture = await mount('ore-time-picker', { props: { value: '00:00' } });
      await open(fixture);
    ...
    it('minute-step of 1 produces 60 options', async () => {
      fixture = await mount('ore-time-picker', { props: { 'minute-step': 1 } });
      await open(fixture);
  ...
  describe('Accessibility', () => {
    it('passes axe checks when closed', async () => {
      fixture = await mount('ore-time-picker', { attrs: { label: 'Pick a time' } });
