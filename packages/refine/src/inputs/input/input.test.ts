...
describe('ore-input', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders helper text when helper attribute is set', async () => {
      fixture = await mount('ore-input', { attrs: { helper: 'Enter your email' } });
  ...
  describe('Input Types', () => {
    ...
    types.forEach((type) => {
      it(`forwards type="${type}" to inner input`, async () => {
        fixture = await mount('ore-input', { attrs: { type } });
    ...
    it('falls back to "text" for invalid type', async () => {
      fixture = await mount('ore-input', { attrs: { type: 'invalid' } });
  ...
  describe('Value Management', () => {
    it('sets initial value in inner input', async () => {
      fixture = await mount('ore-input', { attrs: { value: 'hello world' } });
    ...
    it('updates inner input value when attribute changes', async () => {
      fixture = await mount('ore-input', { attrs: { value: 'initial' } });
    ...
    it('handles empty string value', async () => {
      fixture = await mount('ore-input', { attrs: { value: '' } });
  ...
  describe('Label and Placeholder', () => {
    ...
    it('sets placeholder on inner input', async () => {
      fixture = await mount('ore-input', { attrs: { placeholder: 'Enter email' } });
  ...
  describe('Disabled State', () => {
    it('disables inner input when disabled', async () => {
      fixture = await mount('ore-input', { attrs: { disabled: true } });
  ...
  describe('Readonly State', () => {
    it('sets readOnly on inner input when readonly', async () => {
      fixture = await mount('ore-input', { attrs: { readonly: true } });
  ...
  describe('Required State', () => {
    it('sets required on inner input', async () => {
      fixture = await mount('ore-input', { attrs: { required: true } });
    ...
    it('passes constraint validation while readonly and blank, even when required', async () => {
      fixture = await mount('ore-input', { attrs: { readonly: true, required: true } });
  ...
  describe('Form reset', () => {
    it('restores the value typed by the user when the ancestor form resets', async () => {
      ...
      expect(fixture.query<HTMLInputElement>('input')?.value).toBe('initial');
      form.remove();
    });
    ...
    it('tracks a `value` attribute change made after mount as the new reset target', async () => {
      ...
      expect(fixture.query<HTMLInputElement>('input')?.value).toBe('updated-default');
      form.remove();
    });
  });
  ...
  describe('Error State', () => {
    it('renders error message element with role="alert"', async () => {
      fixture = await mount('ore-input', { attrs: { error: 'Required' } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies ${color} color`, async () => {
        fixture = await mount('ore-input', { attrs: { color } });
    ...
    it('updates color dynamically', async () => {
      fixture = await mount('ore-input', { attrs: { color: 'primary' } });
  ...
  describe('Variants', () => {
    ...
    variants.forEach((variant) => {
      it(`applies ${variant} variant`, async () => {
        fixture = await mount('ore-input', { attrs: { variant } });
    ...
    it('updates variant dynamically', async () => {
      fixture = await mount('ore-input', { attrs: { variant: 'solid' } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies ${size} size`, async () => {
        fixture = await mount('ore-input', { attrs: { size } });
    ...
    it('updates size dynamically', async () => {
      fixture = await mount('ore-input', { attrs: { size: 'sm' } });
  ...
  describe('Edge Cases', () => {
    ...
    it('handles fullwidth attribute', async () => {
      fixture = await mount('ore-input', { attrs: { fullwidth: true } });

      expect(fixture.element.hasAttribute('fullwidth')).toBe(true);
    });

    it('handles rounded attribute', async () => {
      fixture = await mount('ore-input', { attrs: { rounded: 'full' } });
...
describe('ore-input accessibility', () => {
  ...
  describe('Semantic Structure', () => {
    ...
    it('error message has role="alert" for assistive technology announcements', async () => {
      fixture = await mount('ore-input', { attrs: { error: 'Required field' } });
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('clear button is accessible with aria-label="Clear"', async () => {
      fixture = await mount('ore-input', { attrs: { value: 'some text' } });
      await fixture.flush();
