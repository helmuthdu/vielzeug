...
describe('ore-checkbox', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders checkmark and dash icons inside the box', async () => {
      fixture = await mount('ore-checkbox');
      expect(fixture.query('ore-icon[name="check"]')).toBeTruthy();
      expect(fixture.query('ore-icon[name="minus"]')).toBeTruthy();
    });

    it('renders icon state classes expected by the stylesheet', async () => {
      fixture = await mount('ore-checkbox');

      expect(fixture.query('ore-icon.checkmark[name="check"]')).toBeTruthy();
      expect(fixture.query('ore-icon.dash[name="minus"]')).toBeTruthy();
    });
  ...
  describe('Checked State', () => {
    ...
    it('reflects checked attribute when set initially', async () => {
      fixture = await mount('ore-checkbox', { attrs: { checked: true } });
  ...
  describe('Form Integration', () => {
    it('reflects name attribute', async () => {
      fixture = await mount('ore-checkbox', { attrs: { name: 'terms' } });
      expect(fixture.element.getAttribute('name')).toBe('terms');
    });

    it('reflects value attribute', async () => {
      fixture = await mount('ore-checkbox', { attrs: { value: 'accepted' } });
    ...
    it('updates name dynamically', async () => {
      fixture = await mount('ore-checkbox', { attrs: { name: 'a' } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies color="${color}"`, async () => {
        fixture = await mount('ore-checkbox', { attrs: { color } });
        expect(fixture.element.getAttribute('color')).toBe(color);
      });
    });

    it('updates color dynamically', async () => {
      fixture = await mount('ore-checkbox', { attrs: { color: 'primary' } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies size="${size}"`, async () => {
        fixture = await mount('ore-checkbox', { attrs: { size } });
        expect(fixture.element.getAttribute('size')).toBe(size);
      });
    });

    it('updates size dynamically', async () => {
      fixture = await mount('ore-checkbox', { attrs: { size: 'sm' } });
  ...
  describe('Accessibility', () => {
    ...
    it('sets aria-labelledby when label text is provided', async () => {
      fixture = await mount('ore-checkbox', { html: 'Accept terms' });
...
// Dedicated WAI-ARIA / accessibility spec for ore-checkbox
describe('ore-checkbox accessibility', () => {
  beforeAll(async () => {
    await (() => import('./checkbox'))();
  });
  ...
  describe('WAI-ARIA Attributes', () => {
    ...
    it('sets aria-labelledby pointing to label span when label text provided', async () => {
      const fixture = await mount('ore-checkbox', { html: 'Remember me' });
  ...
  describe('Dynamic State Announcements', () => {
    ...
    it('aria-checked transitions from true → false when unchecked', async () => {
      const fixture = await mount('ore-checkbox', { attrs: { checked: true } });
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      const fix = await mount('ore-checkbox', { html: 'Accept terms' });
