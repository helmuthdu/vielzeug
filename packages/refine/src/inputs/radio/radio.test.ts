...
describe('ore-radio', () => {
  ...
  describe('Checked State', () => {
    ...
    it('reflects checked attribute on initial render', async () => {
      fixture = await mount('ore-radio', { attrs: { checked: true } });
  ...
  describe('Disabled State', () => {
    it('reflects disabled attribute', async () => {
      fixture = await mount('ore-radio', { attrs: { disabled: true } });
    ...
    it('does not toggle checked when disabled', async () => {
      fixture = await mount('ore-radio', { attrs: { disabled: true, name: 'grp3' } });
  ...
  describe('Events', () => {
    it('emits change with checked=true on click', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'ev', value: 'yes' } });
    ...
    it('does not emit change when disabled', async () => {
      fixture = await mount('ore-radio', { attrs: { disabled: true, name: 'ev3' } });
    ...
    it('emits change via Space key', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'ev4' } });
    ...
    it('emits change via Enter key', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'ev5' } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies ${color} color`, async () => {
        fixture = await mount('ore-radio', { attrs: { color } });
    ...
    it('updates color dynamically', async () => {
      fixture = await mount('ore-radio', { attrs: { color: 'primary' } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies ${size} size`, async () => {
        fixture = await mount('ore-radio', { attrs: { size } });
    ...
    it('updates size dynamically', async () => {
      fixture = await mount('ore-radio', { attrs: { size: 'sm' } });
  ...
  describe('Accessibility', () => {
    ...
    it('has tabindex="-1" when unchecked (roving tabindex)', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'a11y' } });

      expect(fixture.element.getAttribute('tabindex')).toBe('-1');
    });

    it('has tabindex="0" when checked', async () => {
      fixture = await mount('ore-radio', { attrs: { checked: true, name: 'a11y2' } });
  ...
  describe('Edge Cases', () => {
    it('handles missing name attribute (no group behavior)', async () => {
      fixture = await mount('ore-radio', { attrs: { value: 'standalone' } });
    ...
    it('handles missing value attribute', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'no-val' } });
...
describe('ore-radio accessibility', () => {
  let fixture: Fixture<HTMLElement>;
  ...
  describe('Semantic Structure', () => {
    it('has role="radio" identifying it as a radio button', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'grp', value: 'opt1' } });
  ...
  describe('Roving Tabindex', () => {
    ...
    it('updates tabindex="0" when becoming checked', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'grp2' } });
      expect(fixture.element.getAttribute('tabindex')).toBe('-1');
    ...
    it('removes tabindex when disabled dynamically', async () => {
      fixture = await mount('ore-radio', { attrs: { name: 'grp3' } });
      expect(fixture.element.hasAttribute('tabindex')).toBe(true);
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('navigates to next radio with ArrowDown and selects it', async () => {
      const f1 = await mount('ore-radio', {
        attrs: {
          checked: true,
          name: 'nav-grp',
          value: 'a',
    ...
    it('navigates to next radio with ArrowRight and selects it', async () => {
      ...
      const f2 = await mount('ore-radio', {
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      const fix = await mount('ore-radio', { attrs: { value: 'a' }, html: 'Option A' });
