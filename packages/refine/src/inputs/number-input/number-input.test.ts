...
describe('ore-number-input', () => {
  ...
  describe('Props', () => {
    it('reflects value attribute on host', async () => {
      fixture = await mount('ore-number-input', { attrs: { value: '42' } });
    ...
    it('applies placeholder to inner input', async () => {
      fixture = await mount('ore-number-input', { attrs: { placeholder: '0' } });
      await fixture.flush();
  ...
  describe('Increment / Decrement', () => {
    ...
    it('respects custom step value', async () => {
      fixture = await mount('ore-number-input', { attrs: { step: '5', value: '0' } });
    ...
    it('clamps increase to max value', async () => {
      fixture = await mount('ore-number-input', { attrs: { max: '10', value: '9' } });
    ...
    it('clamps decrease to min value', async () => {
      fixture = await mount('ore-number-input', { attrs: { min: '0', value: '1' } });
    ...
    it('decrease button is disabled when at min', async () => {
      fixture = await mount('ore-number-input', { attrs: { min: '0', value: '0' } });
  ...
  describe('Events', () => {
    it('fires change when the value is committed', async () => {
      fixture = await mount('ore-number-input', { attrs: { value: '1' } });
...
describe('ore-number-input accessibility', () => {
  let fixture: Fixture<HTMLElement>;
