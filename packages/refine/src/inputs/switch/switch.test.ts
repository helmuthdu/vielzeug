...
describe('ore-switch', () => {
  ...
  describe('Checked State', () => {
    ...
    it('reflects checked attribute when set initially', async () => {
      fixture = await mount('ore-switch', { attrs: { checked: true } });
  ...
  describe('Form Integration', () => {
    it('reflects name attribute', async () => {
      fixture = await mount('ore-switch', { attrs: { name: 'notifications' } });
      expect(fixture.element.getAttribute('name')).toBe('notifications');
    });

    it('reflects value attribute', async () => {
      fixture = await mount('ore-switch', { attrs: { value: 'enabled' } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies color="${color}"`, async () => {
        fixture = await mount('ore-switch', { attrs: { color } });
        expect(fixture.element.getAttribute('color')).toBe(color);
      });
    });

    it('updates color dynamically', async () => {
      fixture = await mount('ore-switch', { attrs: { color: 'primary' } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies size="${size}"`, async () => {
        fixture = await mount('ore-switch', { attrs: { size } });
        expect(fixture.element.getAttribute('size')).toBe(size);
      });
    });

    it('updates size dynamically', async () => {
      fixture = await mount('ore-switch', { attrs: { size: 'sm' } });
...
// Dedicated WAI-ARIA / accessibility spec for ore-switch
describe('ore-switch accessibility', () => {
  beforeAll(async () => {
    await (() => import('./switch'))();
  });
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      const fix = await mount('ore-switch', { html: 'Dark mode' });
