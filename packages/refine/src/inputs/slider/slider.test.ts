...
describe('ore-slider', () => {
  ...
  describe('Rendering', () => {
    it('renders the slider track and thumb', async () => {
      fixture = await mount('ore-slider');
  ...
  describe('Value and Range', () => {
    ...
    it('applies custom min/max attributes', async () => {
      fixture = await mount('ore-slider', { attrs: { max: '200', min: '50' } });
    ...
    it('applies step attribute on host', async () => {
      fixture = await mount('ore-slider', { attrs: { step: '5' } });
  ...
  describe('Disabled State', () => {
    it('reflects disabled on host', async () => {
      fixture = await mount('ore-slider', { attrs: { disabled: true } });
    ...
    it('does not emit change event when disabled', async () => {
      fixture = await mount('ore-slider', { attrs: { disabled: true, value: '50' } });
  ...
  describe('Events', () => {
    ...
    it('increases value on ArrowRight', async () => {
      fixture = await mount('ore-slider', { attrs: { step: '10', value: '50' } });
  ...
  describe('Colors', () => {
    ...
    colors.forEach((color) => {
      it(`applies ${color} color`, async () => {
        fixture = await mount('ore-slider', { attrs: { color } });
  ...
  describe('Sizes', () => {
    ...
    sizes.forEach((size) => {
      it(`applies ${size} size`, async () => {
        fixture = await mount('ore-slider', { attrs: { size } });
  ...
  describe('Edge Cases', () => {
    it('clamps value at maximum boundary', async () => {
      fixture = await mount('ore-slider', { attrs: { max: '100', value: '100' } });

      expect(fixture.element.getAttribute('aria-valuenow')).toBe('100');
    });

    it('clamps value at minimum boundary', async () => {
      fixture = await mount('ore-slider', { attrs: { min: '0', value: '0' } });
...
describe('ore-slider accessibility', () => {
  ...
  describe('Semantic Structure', () => {
    ...
    it('host is not focusable when disabled', async () => {
      fixture = await mount('ore-slider', { attrs: { disabled: '' } });
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      const fix = await mount('ore-slider', { attrs: { max: '100', min: '0', value: '50' }, html: 'Volume' });
