...
describe('ore-checkbox-group', () => {
  let fixture: Fixture<HTMLElement>;
  const getCheckboxes = (): HTMLElement[] =>
    Array.from(fixture.element.getElementsByTagName('ore-checkbox')) as HTMLElement[];
  ...
  const checkboxHtml = `
    <ore-checkbox value="a">A</ore-checkbox>
    <ore-checkbox value="b">B</ore-checkbox>
    <ore-checkbox value="c">C</ore-checkbox>
  `;
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      fixture = await mount('ore-checkbox-group', {
        ...
        html: '<ore-checkbox value="a">Option A</ore-checkbox><ore-checkbox value="b">Option B</ore-checkbox>',
      });
