...
describe('ore-radio-group', () => {
  ...
  const radioHtml = `
    <ore-radio value="a">A</ore-radio>
    <ore-radio value="b">B</ore-radio>
    <ore-radio value="c">C</ore-radio>
  `;
  ...
  describe('Core Functionality', () => {
    ...
    it('emits change when slotted radio dispatches change', async () => {
      ...
      const second = fixture.element.querySelectorAll<HTMLElement>('ore-radio')[1];
  ...
  describe('Accessibility', () => {
    it('passes axe checks', async () => {
      fixture = await mount('ore-radio-group', {
        attrs: { label: 'Plan' },
        html: '<ore-radio value="a">Free</ore-radio><ore-radio value="b">Pro</ore-radio>',
      });
