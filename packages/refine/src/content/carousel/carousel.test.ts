...
describe('ore-carousel', () => {
  ...
  describe('Variants', () => {
    ...
    it('marquee: sets data-orientation="vertical" when orientation=vertical', async () => {
      fixture = await mount('ore-carousel', { attrs: { orientation: 'vertical', variant: 'marquee' }, html: slides });
      await fixture.flush();
    ...
    it('marquee: hides controls when show-controls=false', async () => {
      fixture = await mount('ore-carousel', { attrs: { 'show-controls': 'false', variant: 'marquee' }, html: slides });
      await fixture.flush();
    ...
    it('marquee: loop=false sets animation-iteration-count:1 on track', async () => {
      fixture = await mount('ore-carousel', { attrs: { loop: 'false', variant: 'marquee' }, html: slides });
      await fixture.flush();
