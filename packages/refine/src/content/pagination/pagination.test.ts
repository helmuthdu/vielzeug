...
describe('ore-pagination', () => {
  ...
  describe('Rendering', () => {
    it('renders a nav element', async () => {
      fixture = await mount('ore-pagination', { attrs: { 'total-pages': '5' } });
    ...
    it('renders prev/next buttons when show-prev-next is set', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '3', 'show-prev-next': 'true', 'total-pages': '5' } });
    ...
    it('renders first/last buttons when show-first-last is set', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '3', 'show-first-last': 'true', 'total-pages': '5' } });
    ...
    it('hides first/last buttons when show-first-last is false', async () => {
      fixture = await mount('ore-pagination', {
  ...
  describe('Navigation', () => {
    it('clicking a page button updates the page attribute', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '1', 'total-pages': '5' } });
    ...
    it('clicking next button advances the page', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '2', 'show-prev-next': 'true', 'total-pages': '5' } });
    ...
    it('clicking first page button navigates to page 1', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '4', 'show-first-last': 'true', 'total-pages': '5' } });
    ...
    it('clicking last page button navigates to final page', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '2', 'show-first-last': 'true', 'total-pages': '5' } });
    ...
    it('prev button is disabled on first page', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '1', 'show-prev-next': 'true', 'total-pages': '5' } });

      expect(fixture.query<HTMLButtonElement>('[aria-label="Previous page"]')?.disabled).toBe(true);
    });

    it('next button is disabled on last page', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '5', 'show-prev-next': 'true', 'total-pages': '5' } });
  ...
  describe('Events', () => {
    ...
    it('does not fire change when clicking the current page', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '2', 'total-pages': '5' } });
  ...
  describe('Edge Cases', () => {
    it('clamps page to 1 when total-pages is 1', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '1', 'total-pages': '1' } });

      expect(fixture.query('[aria-current="page"]')?.textContent?.trim()).toBe('1');
    });

    it('shows ellipsis for large page counts', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '10', 'total-pages': '20' } });
...
describe('ore-pagination accessibility', () => {
  let fixture: Fixture<HTMLElement>;
  ...
  describe('Nav Landmark', () => {
    it('nav element has aria-label for the landmark', async () => {
      fixture = await mount('ore-pagination', { attrs: { label: 'Article pages', 'total-pages': '5' } });
  ...
  describe('Current Page Indicator', () => {
    it('current page button has aria-current="page"', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '3', 'total-pages': '5' } });
    ...
    it('non-current page buttons do not have aria-current', async () => {
      fixture = await mount('ore-pagination', { attrs: { page: '2', 'total-pages': '3' } });
  ...
  describe('Button Labels', () => {
    it('each page button has an aria-label', async () => {
      fixture = await mount('ore-pagination', { attrs: { 'total-pages': '3' } });
