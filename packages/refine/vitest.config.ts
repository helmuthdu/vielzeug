...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: /^@vielzeug\/dnd\/drop$/, replacement: path.resolve(__dirname, '../dnd/src/drop.ts') },
      ...
      { find: /^@vielzeug\/sentinel$/, replacement: path.resolve(__dirname, '../sentinel/src/index.ts') },
