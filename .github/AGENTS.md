...
| `workflows/ci.yml`           | Runs on push to `main`: the reusable test/lint workflow owns the rebuild.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `workflows/test-pr.yml`      | Runs on PRs: change-file verification and the reusable test/lint workflow run independently; the latter owns the rebuild.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Manual production workflows (`publish.yml`, `release.yml`, and `deploy-docs.yml`) reject
dispatches outside `main`.
