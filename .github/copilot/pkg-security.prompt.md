...
agent: agent
description: >
  Security audit for a Vielzeug package.
  Checks for injection vectors, prototype pollution, unsafe patterns,
  and dependency risks. Run 3 times for thorough coverage.
tools:
  - search/codebase
---
