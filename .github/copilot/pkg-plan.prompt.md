...
agent: agent
description: >
  Analyse a Vielzeug package and produce a structured, DX- and architecture-focused improvement plan.
  Run this 3 times in a row before starting any implementation work — each pass deepens the analysis
  with a greenfield mindset.
tools:
  - search/codebase
