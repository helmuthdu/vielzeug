...
agent: agent
description: >
  Implement the structured improvement plan produced by pkg-plan.
  Writes/edits code, auto-fixes lint, and keeps tests green.
  Run after at least one pkg-plan pass.
tools:
  - search/codebase
