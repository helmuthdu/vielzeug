...
agent: agent
description: >
  Audit, restructure, and expand the test suite for a Vielzeug package.
  Identifies coverage gaps, reorganises tests for clarity, adds edge-case and negative tests,
  and ensures every public export is exercised with high-quality tests.
tools:
  - search/codebase
